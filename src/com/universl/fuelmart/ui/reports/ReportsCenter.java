package com.universl.fuelmart.ui.reports;
 ...
 *
 * Main Report generating processes center - Uses Jasper reporting
 */
...
//      setPreferredSize(new Dimension(340, 285));
        ...
        OrderType.add(radioCreditSlip);
        OrderType.add(radioCreditCard);
    ...
    private void initComponents() {
        ...
        radioCreditSlip = new javax.swing.JRadioButton();
        ...
        radioCreditCard.setText("Credit Card Operations");

        radioCreditSlip.setText("Credit Slip Operations");
        radioCreditSlip.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radioCreditSlipActionPerformed(evt);
            }
        });
    ...
    public void Load() throws Throwable {
        ...
        final JFrame frame = new JFrame("Lanka Fuel Mart Sys.");
    ...
    private void radioCreditSlipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioCreditSlipActionPerformed
    }//GEN-LAST:event_radioCreditSlipActionPerformed
    ...
    private javax.swing.JRadioButton radioCreditSlip;
