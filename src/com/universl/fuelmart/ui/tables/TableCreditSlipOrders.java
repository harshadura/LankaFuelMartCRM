 ...
 *
 * Generate the Table of Credit Slip Orders
 */
public class TableCreditSlipOrders extends javax.swing.JFrame {
    ...
    public TableCreditSlipOrders() {
        try {
            ...
            header.add("shift");
            initComponents();
            setIconImage(Toolkit.getDefaultToolkit().getImage(TableCreditSlipOrders.class.getResource("/resources/logo.png")));
            ...
            setTitle("Table of Credit Slip Orders");
//      setPreferredSize(new Dimension(340, 285));
    ...
    public Vector getAbbr() throws Exception {
        ...
        PreparedStatement pre = con.prepareStatement("select * from CreditSlipOrders");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TableCreditSlipOrders().setVisible(true);
            }
        });
    }
