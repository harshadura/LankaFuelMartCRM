...
//    UIManager.setLookAndFeel(new SyntheticaBlackMoonLookAndFeel());
        ...
        setTitle("Lanka Fuel Mart CRM System");
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/universl/fuelmart/ui/splash/splash.png"))); // NOI18N
        ...
        try {
            ...
            if (results.next()) {
                ...
                if (txtPass.getText().equals(Pass)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Welcome to Lanka Fuel Mart CRM System!", "Lanka Fuel Mart CRM", javax.swing.JOptionPane.INFORMATION_MESSAGE);
