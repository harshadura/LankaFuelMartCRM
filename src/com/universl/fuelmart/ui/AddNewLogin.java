    ...
    private void butAdduserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butAdduserActionPerformed
        try {
            if (txtUser2.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Enter the Username!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (txtPass2.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Enter the Password!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (txtPass2Con.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Enter the Confirm Password!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (!txtPass2.getText().equals(txtPass2Con.getText())) {
                JOptionPane.showMessageDialog(this, "Please Confirm the Password Properly!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }

            ResultSet results = stm.executeQuery("select * from Login where strUser='" + txtUser2.getText() + "'");
            if (results.next()) {
                JOptionPane.showMessageDialog(this, "Sorry this Username already Exist!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }

            String sql1 = "insert into Login (strUser, strPass) values ('" + txtUser2.getText() + "','" + txtPass2.getText() + "')";
            stm.executeUpdate(sql1);
            JOptionPane.showMessageDialog(this, "Thanks new User added!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            clear();
