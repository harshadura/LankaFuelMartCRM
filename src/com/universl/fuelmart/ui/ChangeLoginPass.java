...
//      setPreferredSize(new Dimension(340, 285));
    ...
    private void butUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butUpdateActionPerformed
        ...
        if (txtOldPass.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Enter the old Password!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (txtNewPass.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Enter the new Password!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
            ...
            while (results.next()) {
                ...
                if (txtOldPass.getText().equals(Pass)) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Password Successfully changed!", "Lanka Fuel Mart Sys.", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                            clear();
                        return;
